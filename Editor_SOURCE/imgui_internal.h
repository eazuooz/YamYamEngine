...
struct ImGuiListClipperData
{
    ...
    void                            RenderTargetViewReset(ImGuiListClipper* clipper) { ListClipper = clipper; StepNo = ItemsFrozen = 0; Ranges.resize(0); }
};
...
struct IMGUI_API ImGuiWindow
{
    ...
    int                     ViewportAllowPlatformMonitorExtend; // RenderTargetViewReset to -1 every frame (index is guaranteed to be valid between NewFrame..EndFrame), only used in the Appearing frame of a tooltip/popup to enforce clamping to a given monitor
...
struct IMGUI_API ImGuiTable
{
    ...
    ImGuiTableColumnIdx         ResizedColumn;              // Index of column being resized. RenderTargetViewReset when InstanceCurrent==0.
