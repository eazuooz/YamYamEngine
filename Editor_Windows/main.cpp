                     ...
                     _In_ int       nCmdShow)
{
    ...
    ImGui_ImplDX11_Init(ya::GetDevice()->GetID3D11Device()
        , ya::GetDevice()->GetID3D11DeviceContext());
    ...
    MSG msg;
    HACCEL hAccelTable 
        = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_EDITORWINDOWS));
    while (true)
    {
